    ...
    return {
        ...
        renderPayPalButtons: function(element) {
            if (
                ...
                window.checkoutConfig.hasOwnProperty('allowed_payment_methods') &&
                $.inArray('paypal_express', window.checkoutConfig.allowed_payment_methods.split(',')) !== -1
            ) {
                $('#paypalotp').css('display', 'block');
                $('#paypal-express-in-context-button').css({ 'opacity': 0.5, 'pointer-events': 'none' });
            }
